...
I'm also expert in SQL and relational **databases** _(complex queries, optimizations, triggers, procedures, architecture...)_,
...
but really, I'm not a graphic designer _(although I ~~designed~~ committed this CV by myself)_.
